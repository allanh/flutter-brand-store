...
@JsonSerializable()
class SiteSetting {
  SiteSetting(this.date, this.annonmousKey, this.status, this.store, this.layout, this.menu);
  static late SiteSetting current = SiteSetting(DateTime.now(), '', SiteStatus.empty, StoreSetting.empty, LayoutSetting.empty, MenuSetting.empty);
